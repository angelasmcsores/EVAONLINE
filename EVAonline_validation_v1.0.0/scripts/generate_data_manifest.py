...
META_CSV_PATH = "./data/map_data/cities_plot.csv"  # CSV with meteorological station data (MA, TO, PI, BA)
BRASIL_GEOJSON_PATH = "./data/map_data/BR_UF_2024.geojson"  # GeoJSON with Brazil's state boundaries
MATOPIBA_GEOJSON_PATH = "./data/map_data/Matopiba_Perimetro.geojson"  # GeoJSON with MATOPIBA perimeter
CLIMATE_SHAPEFILE_PATH = (
    "./data/shapefile_climate/clima_5000.shp"  # Shapefile with climate zones
)
CLIMATE_COLUMN_NAME = (
    "DESC_COMPL"  # Column in the shapefile with climate descriptions
)
OUTPUT_MAP_PATH = "./figures/study_area_map.png"  # Output map file
